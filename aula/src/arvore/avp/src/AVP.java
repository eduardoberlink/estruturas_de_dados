 ...
 * <p>
 * Esta estrutura garante altura logarítmica e operações eficientes de busca,
 * inserção e remoção.
 * </p>
 *
...
public class AVP<T extends Comparable<T>> implements Arborizavel<T> {
     ...
     *             <p>
     *             Se o elemento já existir, será inserido como duplicado (lado
     *             esquerdo).
     *             </p>
     */
    @Override
    ...
    private void removerNo(NoTriplo<T> no) {
        ...
        NoTriplo<T> filho = (noParaRemover.getEsquerda() != null) ? noParaRemover.getEsquerda()
                : noParaRemover.getDireita();
    ...
    /**
     * Formata a saída dos métodos de impressão, removendo espaços extras e
     * ajustando separadores.
     * 
     * @param msg String a ser formatada.
     * @return String formatada.
     */
    private String formataSaida(String msg) {
        // Substitui um ou mais espaços em branco por uma vírgula, após remover espaços
        // das bordas
