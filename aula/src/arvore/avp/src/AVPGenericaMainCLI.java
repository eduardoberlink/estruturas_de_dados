...
/**
 * Interface de linha de comando para manipular uma árvore vermelho e preto
 * genérica.
 * Permite inserir, buscar, remover e imprimir elementos de qualquer tipo
 * Comparable.
 *
...
public class AVPGenericaMainCLI {
    /**
     * Método principal. Inicia o menu interativo para manipulação da árvore
     * vermelho e preto.
     * 
